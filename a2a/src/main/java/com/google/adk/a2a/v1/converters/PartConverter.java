 ...
 */
package com.google.adk.a2a.v1.converters;
...
public final class PartConverter {
  ...
  public static Optional<TextPart> toTextPart(org.a2aproject.sdk.spec.Part<?> part) {
  ...
  public static com.google.genai.types.Part toGenaiPart(org.a2aproject.sdk.spec.Part<?> a2aPart) {
    ...
    if (a2aPart instanceof TextPart textPart) {
      com.google.genai.types.Part.Builder partBuilder =
          com.google.genai.types.Part.builder().text(textPart.text());
      if (textPart.metadata() != null) {
        partBuilder.partMetadata(textPart.metadata());
        if (Objects.equals(textPart.metadata().get("thought"), true)) {
  ...
  public static ImmutableList<com.google.genai.types.Part> toGenaiParts(
      List<org.a2aproject.sdk.spec.Part<?>> a2aParts) {
  ...
  private static com.google.genai.types.Part convertFilePartToGenAiPart(FilePart filePart) {
    ...
    Map<String, Object> metadata = filePart.metadata();
  ...
  private static com.google.genai.types.Part convertDataPartToGenAiPart(DataPart dataPart) {
    Map<String, Object> data = coerceToMap(dataPart.data());
    Map<String, Object> metadata =
        Optional.ofNullable(dataPart.metadata()).map(HashMap::new).orElseGet(HashMap::new);
  ...
  public static Content messageToContent(Message message) {
    ImmutableList<com.google.genai.types.Part> parts = toGenaiParts(message.parts());
  ...
  private static DataPart inlineDataToA2ADataPart(
    ...
    try {
      ...
      if (deserialized.metadata() != null) {
        mergedMetadata.putAll(deserialized.metadata());
      }
      mergedMetadata.putAll(metadata);

      return new DataPart(deserialized.data(), mergedMetadata.buildKeepingLast());
    } catch (Exception e) {
  ...
  public static org.a2aproject.sdk.spec.Part<?> fromGenaiPart(Part part, boolean isPartial) {
    if (part == null) {
