 ...
 * decides only <em>what the model is told</em>. Both templates are ports of the f-strings in
...
final class ReflectionGuidance {
   ...
   * configured {@code max_retries} here instead; this port reports the observed count.
   */
