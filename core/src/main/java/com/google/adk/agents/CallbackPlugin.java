...
public class CallbackPlugin extends PluginManager {
  ...
  private <T> ImmutableList<T> getCallbacks(Class<T> type) {
    return callbacks.get(type).stream()
        .map(callback -> (T) callback)
  ...
  public static class Builder {
    ...
    public Builder addBeforeAgentCallback(Callbacks.BeforeAgentCallback callback) {
      ...
      plugins.add(
          new BasePlugin("BeforeAgentCallback_" + callback.hashCode()) {
            @Override
    ...
    public Builder addAfterAgentCallback(Callbacks.AfterAgentCallback callback) {
      ...
      plugins.add(
          new BasePlugin("AfterAgentCallback_" + callback.hashCode()) {
            @Override
    ...
    public Builder addBeforeModelCallback(Callbacks.BeforeModelCallback callback) {
      ...
      plugins.add(
          new BasePlugin("BeforeModelCallback_" + callback.hashCode()) {
            @Override
    ...
    public Builder addAfterModelCallback(Callbacks.AfterModelCallback callback) {
      ...
      plugins.add(
          new BasePlugin("AfterModelCallback_" + callback.hashCode()) {
            @Override
    ...
    public Builder addBeforeToolCallback(Callbacks.BeforeToolCallback callback) {
      ...
      plugins.add(
          new BasePlugin("BeforeToolCallback_" + callback.hashCode()) {
            @Override
    ...
    public Builder addAfterToolCallback(Callbacks.AfterToolCallback callback) {
      ...
      plugins.add(
          new BasePlugin("AfterToolCallback_" + callback.hashCode()) {
            @Override
    ...
    public Builder addBeforeAgentCallbacks(
        @Nullable List<? extends BeforeAgentCallbackBase> callbacks) {
    ...
    public Builder addAfterAgentCallbacks(
        @Nullable List<? extends AfterAgentCallbackBase> callbacks) {
      if (callbacks == null || callbacks.isEmpty()) {
        return this;
      }
      callbacks.forEach(this::addCallback);
    ...
    public Builder addBeforeModelCallbacks(
        @Nullable List<? extends BeforeModelCallbackBase> callbacks) {
      if (callbacks == null || callbacks.isEmpty()) {
        return this;
      }
      callbacks.forEach(this::addCallback);
    ...
    public Builder addAfterModelCallbacks(
        @Nullable List<? extends AfterModelCallbackBase> callbacks) {
      if (callbacks == null || callbacks.isEmpty()) {
        return this;
      }
      callbacks.forEach(this::addCallback);
    ...
    public Builder addBeforeToolCallbacks(
        @Nullable List<? extends BeforeToolCallbackBase> callbacks) {
      if (callbacks == null || callbacks.isEmpty()) {
        return this;
      }
      callbacks.forEach(this::addCallback);
    ...
    public Builder addAfterToolCallbacks(
        @Nullable List<? extends AfterToolCallbackBase> callbacks) {
      if (callbacks == null || callbacks.isEmpty()) {
        return this;
      }
      callbacks.forEach(this::addCallback);
