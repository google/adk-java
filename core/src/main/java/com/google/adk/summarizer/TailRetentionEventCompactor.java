...
public final class TailRetentionEventCompactor implements EventCompactor {
   ...
   *   <li>T=3: E3
   *   <li>T=4: E4
   *   <li>T=5: C1 (Covers T=1). getCompactionEvents returns <i>List: E1 </i>. E2, E3, E4 are
   *       preserved.
   *   <li>T=6: E6
   *   <li>T=7: E7
   *   <li>T=8: C2 (Covers T=1 to T=3; starts at T=1 because it includes C1). getCompactionEvents
   *       returns <i>List: C1, E2, E3</i>. E4, E6, E7 are preserved.
   *   <li>T=9: E9.
   * </ul>
   *
