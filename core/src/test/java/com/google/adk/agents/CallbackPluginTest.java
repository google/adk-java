...
public final class CallbackPluginTest {
  ...
  @Test
  public void addBeforeAgentCallbacks_nullOrEmpty() {
    CallbackPlugin plugin =
        CallbackPlugin.builder()
            .addBeforeAgentCallbacks(null)
            .addBeforeAgentCallbacks(ImmutableList.of())
            .build();
    assertThat(plugin.getBeforeAgentCallback()).isEmpty();
  }

  @Test
  public void addAfterAgentCallbacks_nullOrEmpty() {
    CallbackPlugin plugin =
        CallbackPlugin.builder()
            .addAfterAgentCallbacks(null)
            .addAfterAgentCallbacks(ImmutableList.of())
            .build();
    assertThat(plugin.getAfterAgentCallback()).isEmpty();
  }

  @Test
  public void addBeforeModelCallbacks_nullOrEmpty() {
    CallbackPlugin plugin =
        CallbackPlugin.builder()
            .addBeforeModelCallbacks(null)
            .addBeforeModelCallbacks(ImmutableList.of())
            .build();
    assertThat(plugin.getBeforeModelCallback()).isEmpty();
  }

  @Test
  public void addAfterModelCallbacks_nullOrEmpty() {
    CallbackPlugin plugin =
        CallbackPlugin.builder()
            .addAfterModelCallbacks(null)
            .addAfterModelCallbacks(ImmutableList.of())
            .build();
    assertThat(plugin.getAfterModelCallback()).isEmpty();
  }

  @Test
  public void addBeforeToolCallbacks_nullOrEmpty() {
    CallbackPlugin plugin =
        CallbackPlugin.builder()
            .addBeforeToolCallbacks(null)
            .addBeforeToolCallbacks(ImmutableList.of())
            .build();
    assertThat(plugin.getBeforeToolCallback()).isEmpty();
  }

  @Test
  public void addAfterToolCallbacks_nullOrEmpty() {
    CallbackPlugin plugin =
        CallbackPlugin.builder()
            .addAfterToolCallbacks(null)
            .addAfterToolCallbacks(ImmutableList.of())
            .build();
    assertThat(plugin.getAfterToolCallback()).isEmpty();
  }
}
