...
public final class SequentialAgentTest {
  ...
  // Legacy resumption reconstructs the resume point from history, so it fast-forwards past
  // completed sub-agents with no checkpoints in the session. The resumable flow does not: it
  // resumes from its own checkpoints, as Python ADK does.
  @Test
