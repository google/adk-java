...
public final class LoopAgentTest {
  ...
  public void runAsync_resumable_belowIterationCap_loopsExactlyMaxIterations() {
    // A fresh resumable run below the cap must loop exactly maxIterations times, guarding the cap
    // comparison timesLooped >= maxIterations; complements runAsync_resumingAtIterationCap_*.
    TestBaseAgent subAgent =
        createSubAgent(
