...
public final class ApplicationIntegrationToolTest {
  ...
  private ApplicationIntegrationTool integrationTool;
  private ApplicationIntegrationTool connectorTool;
  private ApplicationIntegrationTool connectorToolWithAction;
  private ApplicationIntegrationTool connectorToolWithServiceAccount;
  ...
  public void integrationTool_runAsync_success() throws Exception {
    ...
    ApplicationIntegrationTool spyTool = spy(integrationTool);
  ...
  public void connectorTool_runAsync_success() throws Exception {
    ...
    ApplicationIntegrationTool spyTool = spy(connectorTool);
  ...
  public void connectorToolWithAction_runAsync_success() throws Exception {
    ...
    ApplicationIntegrationTool spyTool = spy(connectorToolWithAction);
    var unused = spyTool.declaration();
  ...
  public void connectorToolWithServiceAccount_runAsync_success() throws Exception {
    String expectedResponse = "{\"action_result\":\"success\"}";
    ApplicationIntegrationTool spyTool = spy(connectorToolWithServiceAccount);
    var unused = spyTool.declaration();
