...
public class StateManagementTest {
  ...
  public void testAppStateSharing() {
    ...
    Session retrieved1 =
        sessionService.getSession(TEST_APP_NAME, TEST_USER_ID_1, sessionId1).blockingGet();
    Session retrieved2 =
        sessionService.getSession(TEST_APP_NAME, TEST_USER_ID_2, sessionId2).blockingGet();
  ...
  public void testUserStateSharing() {
    ...
    Session session1 =
        sessionService.getSession(TEST_APP_NAME, TEST_USER_ID_1, sessionId1).blockingGet();
    Session session2 =
        sessionService.getSession(TEST_APP_NAME, TEST_USER_ID_1, sessionId2).blockingGet();
  ...
  public void testAllStateIsPersisted() {
    ...
    Session retrieved =
        sessionService.getSession(TEST_APP_NAME, TEST_USER_ID_1, sessionId).blockingGet();
