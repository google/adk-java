            ...
            invocation -> {
              ...
              try (VectorSchemaRoot root =
                ...
                for (int i = 0; i < root.getRowCount(); i++) {
                  ...
                  row.put(
                      "event_type", Objects.toString(root.getVector("event_type").getObject(i)));
                  row.put("agent", Objects.toString(root.getVector("agent").getObject(i)));
                  row.put(
                      "session_id", Objects.toString(root.getVector("session_id").getObject(i)));
                  row.put(
                      "invocation_id",
                      Objects.toString(root.getVector("invocation_id").getObject(i)));
                  row.put("user_id", Objects.toString(root.getVector("user_id").getObject(i)));
                  row.put(
                  ...
                  row.put("content", Objects.toString(root.getVector("content").getObject(i)));
