...
public final class LiveInteropTools {
   ...
   */
  public static final AtomicBoolean STATE_PROBE_PLUGIN_VISIBLE = new AtomicBoolean(false);
  ...
  public static ImmutableMap<String, Object> inspectPlugins(
    ...
    STATE_PROBE_PLUGIN_VISIBLE.set(visible);
  ...
  @Schema(description = "Looks up the user's remembered favorite color.")
  public static ImmutableMap<String, Object> recallColor(
      @Schema(name = "toolContext") ToolContext toolContext) {
    return ImmutableMap.of("color", String.valueOf(toolContext.state().get("favorite_color")));
  }
