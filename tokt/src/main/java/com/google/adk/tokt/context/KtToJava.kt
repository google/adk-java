...
internal class KtInvocationContextToJavaView(private val ic: KtInvocationContext) :
  ...
  // A Java view of the Kotlin invocation's plugins (adapted Java plugins unwrapped), so a Java tool
  // such as an AgentTool with includePlugins sees them; the returned manager rejects registration.
